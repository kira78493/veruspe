...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__c",
      "vtp_value":["map","",18411,"8e6Kbyh7SMaGvhVX0hQq1g",18433,"mBQEA72zSkWsLr8V1MY1PA",18504,"Vpbo62E7QdCh3u0wM6Gb4Q",18504]
    },{
      "function":"__gthc",
      "vtp_trackingId":"UA-69122442-10"
    },{
      ...
      "vtp_experimentKey":"OPT-5MXPMD9_OPT-WPHR4",
      "function":"__c",
      "vtp_value":true
    },{
      "function":"__exs",
      "vtp_measurementId":"Vpbo62E7QdCh3u0wM6Gb4Q",
      "vtp_sections":["list",4]
    },{
      "vtp_experimentKey":"OPT-5MXPMD9_OPT-WPHR4",
      "function":"__c",
  ...
  "tags":[{
      ...
      "vtp_activate":true,
      "vtp_isEmpty":false,
      "vtp_treatmentId":"Experiment_OPT-5MXPMD9_OPT-WPHR4:0",
      "vtp_contextIndex":0,
      "tag_id":52
    },{
      "function":"__uae",
...
var l,m=jd.s,q=Tc('script[src*="gtm/js?id='+m+'"],script[src*="optimize.js?id='+m+'"]');l=q&&0<q.length?q[0]:null;b||(b="gaoo");var r=zj(Aj,l&&l.src),t=r.Ab,p=r.Bb,u=r.jc,w=r.kc,v=r.Wb,x=r.qc,y=r.tb,A=r.Uc,B=r.sb;"h0"!=y||Bj||(y="h3");Cj={tb:y,sb:B,wg:a,Sg:b,Uc:A,kc:w,Wb:v,qc:x,jc:u,Ab:t,Bb:p,we:Dj,
Ve:Ej};Fj(Cj)}catch(z){console.log("[opttick] - "+jd.s+": exception: "+z)}},Hj=function(){var a=E.gaData,b=0,c=void 0;if(a)for(var d in a)if(a.hasOwnProperty(d)&&0===d.indexOf("UA-")&&a[d].hitcount){b+=a[d].hitcount;var e=Number(a[d].first_hit);e&&(!c||e<c)&&(c=e)}return{ze:b,te:c}},zj=function(a,b){var c,d,e,f,h,k,l,m,q;var r=E.performance;if(r){var t=r.getEntries();if(b){var p=r.getEntriesByName(b)[0];t&&1<t.length&&p&&(f=Math.round(p.startTime-
t[1].startTime),h=Math.round(p.duration),e=t.indexOf(p),-1===e&&(e=void 0),k=Math.round(a-(p.startTime+p.duration)))}var u=r.timing;if(u.domContentLoadedEventStart){var w=u.domContentLoadedEventStart-u.navigationStart;w&&(d=Math.round(a-w))}var v=r.getEntriesByType("paint").filter(function(B){return"first-contentful-paint"===B.name})[0];v&&(c=Math.round(a-v.startTime))}var x=E["dataLayer"].hide;if(x){if(void 0===x[jd.s])l="h2";else{var y=!1;if(null===x.end)for(var A in x)if(x.hasOwnProperty(A)&&
A.startsWith(jd.s)&&!0===x[A]){y=!0;break}l=y?"h0":"h1"}x.start&&!isNaN(x.start)&&(r?r.timing&&(q=Math.round(a+r.timing.navigationStart-x.start)):q=a-x.start);isNaN(x.timeout)||(m=x.timeout)}return{Ab:d,Bb:c,jc:e,kc:f,Wb:h,qc:k,tb:l,Uc:m,sb:q}},Fj=function(a,b){b=void 0===b?"ol":b;var c=function(e,f){null!=f&&(d+=e+encodeURIComponent(f))},d=td;c("&t=",b);c("&s=",a.tb);c("&h=",a.sb);c("&g=",a.wg);c("&p=",a.Sg);c("&o=",a.Uc);c("&l=",qd?yj-
Aa(qd):void 0);c("&q=",a.kc);c("&f=",a.Wb);c("&e=",a.qc);c("&i=",a.jc);c("&d=",a.Ab);c("&c=",a.Bb);c("&tr=",a.uh);c("&jl=",a.Qg);c("&jf=",a.Og);c("&ji=",a.Pg);c("&jq=",a.Rg);c("&jd=",a.Mg);c("&jx=",a.Ng);c("&hc=",a.we);c("&fh=",a.Ve);d+="&sr=0.050000";c("&ps=",Ij);c("&cb=",va());mc(d);},Jj=!1,yj,Aj,Bj,Ij,Cj,Dj,Ej;Ij=Math.random(),Jj="0.050000">Ij;var Lj=function(){
if(!Jj||yj)return;yj=Fa();Aj=performance&&performance.now()||yj;Bj=!!F.querySelector("body");var a=Hj(),b=a.te;Dj=a.ze;Ej=b?yj-b:void 0;xj(Gj);},Nj=function(a){var b=Mj;if(!Jj)return;try{var c=Fa(),d=performance&&performance.now()||c,e=Hj(),f=e.ze,h=e.te,k=h?c-h:void 0;xj(function(){var l=zj(d,b),m=Object.assign(Cj||{},a,{tb:l.tb,sb:l.sb,Ab:l.Ab,Bb:l.Bb,Pg:l.jc,Rg:l.kc,Mg:l.Wb,Ng:l.qc,we:f,Ve:k});Fj(m,"od")})}catch(l){console.log("[odtick] - "+
